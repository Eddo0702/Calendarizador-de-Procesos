...
public class Test {
	...
	public static void main(String[] args) {
		...
		*/
		...
		procesos.add(new Proceso(1, 8, 14, 5));
		procesos.add(new Proceso(2, 12, 22, 2));
		procesos.add(new Proceso(3, 0, 8, 8));
		procesos.add(new Proceso(4, 6, 16, 5));
		procesos.add(new Proceso(5, 24, 26, 7));
		procesos.add(new Proceso(6, 16, 24, 9));
		procesos.add(new Proceso(7, 20, 12, 4));
		procesos.add(new Proceso(8, 22, 18, 8));		
